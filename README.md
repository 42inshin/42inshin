...
### 🚀 [개인 프로젝트: "월간 신인호" (2026)](https://devgood42.github.io)

*2026년 한 해 동안 매달 하나의 제품을 출시하며 일상의 문제를 해결하는 프로젝트 시리즈입니다.*

- **[7] memone**: 쏟아낸 생각을 AI가 하나의 아이디어 단위로 쪼개고 이어 주는, 서버 없이 기기에만 저장하는 제텔카스텐 메모 앱 (iOS/Android 출시)
- **[6] 북극성**: 바쁜 일상 속에서 흐려진 방향을 선명하게 잡아 주는 목표 설정 앱 (iOS 출시)
- **[5] 하루컬러**: 일상에서 마주친 순간의 색을 사진으로 담아 나만의 팔레트로 모아 가는 컬러헌팅 앱 (iOS 출시)
- **[4] 우링(ooring) - 쓰담쓰담 가사 알림**: 가사 분담의 심리적 문턱을 낮추고 고마움을 짧게 전하는 가사 관리 앱 (iOS 출시)
- **[3] Re:Post - N년 다이어리**: Obsidian에서 영감을 받은 프라이버시 중심 로컬 저장 다이어리 (iOS/Android 출시)
- **[2] Scoreboard - Live & Share**: 실시간 점수 공유 및 기록 애플리케이션 (iOS/Android 출시)
- **[1] Pomotime - 포커스 타이머**: 미니멀한 크로스 플랫폼 뽀모도로 타이머 (iOS/Android 출시)
...
: 쏟아낸 생각을 AI가 하나의 아이디어 단위로 쪼개고 이어 주는, 서버 없이 기기에만 저장하는 제텔카스텐 메모 앱입니다. (2026년 8월 출시)

**[북극성](https://devgood42.github.io/magazine.html#issue-06)**
: 바쁜 일상 속에서 흐려진 나의 방향을 선명하게 만드는데 도움을 주는 목표 설정 앱입니다. (2026년 6월 출시)

**[하루컬러](https://devgood42.github.io/magazine.html#issue-05)**
: 일상에서 마주친 순간의 색을 사진으로 담아 나만의 팔레트로 모아 가는 컬러헌팅 앱입니다. (2026년 5월 출시)
